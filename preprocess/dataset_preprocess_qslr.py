...
def csv2dict(anno_path, dataset_type):
    ...
    info_dict = dict()
    info_dict['prefix'] = anno_path.rsplit("/", 3)[0] + "/features/fullFrame-480x480px"
...
def resize_img(img_path, dsize='480x480px'):
...
def resize_dataset(video_idx, dsize, info_dict):
    ...
    for img_path in img_list:
        ...
        rs_img_path = img_path.replace("480x480px", dsize)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='QSLR2024',
                        help='save prefix')
    parser.add_argument('--dataset-root', type=str, default='../dataset/QSLR2024',
